...
// Owner & Bot Details
global.owner = process.env.OWNER_NUMBER; "2348164454273"
global.anitav4 = process.env.BOT_NAME || "Danny Tech - 𝟒";
global.ownername = process.env.OWNER_NAME || "Danny";
global.packname = process.env.PACK_NAME || "Danney";
global.author = process.env.AUTHOR || "𝐃anney";
global.channelname = process.env.CHANNEL_NAME || "𝐃anny";
...
global.mess = {
    ...
    botAdmin: process.env.MESSAGE_BOT_ADMIN || '_*❗This Command Can Only Be Used When Danney Becomes Group Admin !*_',
    OnlyOwner: process.env.MESSAGE_OWNER || '_*❗This Command Can Only Be Used By My Danney !*_',
    ...
    premium: process.env.MESSAGE_PREMIUM || '_*Premium only" Want Premium? Chat Owner*_'2348164454273',
